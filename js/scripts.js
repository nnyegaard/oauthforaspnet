...
;!function(t){var e,o,a;t.fn.tooltip=function(i){var d={delay:100};i=t.extend(d,i);var l=t(this),n=5,s=t("<div></div");s.addClass("material-tooltip").text(l.attr("data-tooltip")),s.appendTo(t("body"));var c=t("<div></div").addClass("backdrop");c.appendTo(s),c.css({top:0,left:0,marginLeft:s.outerWidth()/2-c.width()/2}),o=!1,this.hover(function(){e=0,a=setInterval(function(){e+=1,e==d.delay&&0==o&&(o=!0,s.css({display:"block"}),s.css({top:l.offset().top+l.outerHeight()+n,left:l.offset().left+l.outerWidth()/2-s.outerWidth()/2}),s.velocity({opacity:1,marginTop:"+10px"},{duration:250,queue:!1}),c.css({display:"block"}).velocity({opacity:1},{duration:200,delay:0,queue:!1}).velocity({scale:12},{duration:250,delay:20,queue:!1,easing:"easeInOutQuad"}))},1)},function(){clearInterval(a),e=0,s.velocity({opacity:0,marginTop:"-10px"},{duration:225,queue:!1,delay:275}),c.velocity({opacity:0,scale:1},{duration:225,delay:275,queue:!1,complete:function(){c.css("display","none"),s.css("display","none"),o=!1}})})}}(jQuery);
...
;function toast(t,a,e){function o(t){var a=$("<div></div>");a.addClass("toast"),a.addClass(e);var o=$("<span></span>");return o.text(t),a.append(o),a}if(e=e||"",0==$("#toast-container").length){var i=$("<div></div>").attr("id","toast-container");$("body").append(i)}var i=$("#toast-container"),n=o(t);i.append(n),n.css({top:parseFloat(n.css("top"))+35+"px",opacity:0}),n.velocity({top:"0px",opacity:1},{duration:300,easing:"easeOutCubic",queue:!1}),n.velocity({opacity:0,marginTop:"-40px"},{duration:375,easing:"easeOutExpo",queue:!1,delay:a,complete:function(){$(this).remove()}})}
